...
<<<<<<< HEAD
    ...
    else if (!validateInternalRef(form.internalRef)) { setInternalRefError(true); setSnackbar({ open: true, message: 'Internal Ref No format: ABC123, AB1234, ABC 123, or AB 1234', severity: 'error' }); return; }
